...
# Group=v2ray
Type=simple
PIDFile=/run/v2rayKCP.pid
ExecStart=/usr/bin/v2ray/v2ray -config /root/v2ray/config/config_kcp.json
Restart=on-failure
...
- 新添加的unit配置文件或者配置文件改动需要执行 daemon-reload
```
