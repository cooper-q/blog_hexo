...
语法|返回值|实例
-|-|-
del key_name|被删除 key 的数量|redis 127.0.0.1:6379>DEL w3ckey<br/>(integer) 1

- DUMP key 序列化给定key，并返回被序列化的值

语法|返回值|实例
-|-|-
DUMP KEY_NAME|如果 key 不存在，那么返回 nil 。 否则，返回序列化之后的值。|redis> DUMP greeting<br/>"\x00\x15hello, dumping world!\x06\x00E\xa0Z\x82\xd8r\xc1\xde"<br/>redis>DUMP not-exists-key<br/>(nil)
