...
### 25.redis的使用
### 26.mysql 
- [mysql explain](/2019-09-17-mysql%20explain详解/)
- [mysql 索引详解](/2019-09-10-MySQL索引详解/)
- 数据库聚合 
- 大数据写入 
- 读写分离 
- 副本集 
...
### 34.javascript 权威指南
### 35.观看数据计划JavaScript语言精粹、JavaScript模式、JavaScript设计模式和开发实践、JavaScript设计模式、SQL反模式
- [ ] JavaScript语言精粹
- [ ] JavaScript模式
- [ ] JavaScript设计模式和开发实践
- [ ] JavaScript设计模式
